...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> updateApproval(Long userId, Long bookingId, Boolean approved) {
    ...
    public ResponseEntity<Object> getAllByUserId(Long userId, String state) {
        return get("?state={state}", userId, Map.of("state", state));
    }

    public ResponseEntity<Object> getAllByOwnerId(Long userId, String state) {
